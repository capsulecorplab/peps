...
SERVER_DEST_DIR_BASE = (
    '/data/ftp.python.org/pub/beta.python.org/build/data/dev/seps')
RFCURL = 'http://www.faqs.org/rfcs/rfc%d.html'
SEPCVSURL = 'http://hg.python.org/seps/file/tip/sep-%04d.txt'
SEPDIRURL = '/dev/seps/'
...
SEP, see http://www.python.org/dev/seps/sep-0001 for instructions and links
            ...
            if basename == 'sep-0000.txt':
                ...
                if len(parts) > 1 and re.match(r'\s*\d{1,4}', parts[1]):
                    ...
                    print >> outfile, re.sub(
                        parts[1],
                        '<a href="/dev/seps/sep-%04d/">%s</a>' % (int(parts[1]),
                            parts[1]), line, 1),
                    continue
...
def fix_rst_sep(inpath, input_lines, outfile):
    ...
    from docutils.transforms.seps import Headers
    Headers.sep_cvs_url = SEPCVSURL
